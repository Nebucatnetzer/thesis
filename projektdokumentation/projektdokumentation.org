...
Feststellungen:
- "Include" und "Exclude" Funktionen sind klar beschriftet.
...
Applikation angezeigt wird. Es gibt ihm einen kurzen Überblick welcher Button
welche Aktion auslöst und welche Elemente, welche Information anzeigen.
Optional kann der Benutzer entscheiden, dass er das Fenster beim nächsten Start
nicht mehr angezeigt bekommen möchte. Über den Button "Help" kann das Fenster
jederzeit unabhängig der Einstellungen wieder angezeigt werden.
